...
// import { clamp, smoothstep, color, uniform, vec4, mix, vec2, positionWorld, step } from 'three/tsl'

// const toAntialiasedGrid = ([inputUv, scale, thickness, offset, cross]) =>
// {
//     const lineWidth = thickness
//     const referenceUv = inputUv.div(scale).add(offset)
...
// {
//     constructor(colorValue = 0xffffff, scale = 1, thickness = 0.05, cross = 1, offset = vec2(0))
//     {
//         this.color = uniform(color(colorValue))
...
// export default class MeshGridMaterial extends NodeMaterial
// {
...
//         this.setGridParameters(parameters)

//         const uvReference = positionWorld.xz
...
import { Color, NodeMaterial } from 'three/webgpu'
import { clamp, smoothstep, If, color, Fn, uniform, vec3, vec4, positionLocal, positionWorld, normalWorld, mix, vec2, uv, step } from 'three/tsl'
